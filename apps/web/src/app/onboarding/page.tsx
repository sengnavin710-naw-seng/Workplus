    ...
    <main className="min-h-screen bg-[var(--canvas)] text-[var(--ink)] lg:grid lg:grid-cols-[minmax(0,1.08fr)_minmax(24rem,0.92fr)]">
      ...
      >
        <div className="w-full max-w-md">
          <div className="inline-flex items-center gap-2 rounded-full bg-[color-mix(in_srgb,var(--primary)_12%,transparent)] px-3 py-1.5 text-[var(--primary)]">
            <ShieldCheck aria-hidden="true" className="size-5" strokeWidth={1.8} />
            <p className="text-xs font-medium uppercase tracking-[0.14em]">Private by default</p>
          </div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-6 text-[color-mix(in_srgb,var(--ink)_68%,transparent)]">
            Setup never starts activity tracking.
          </p>
          ...
          <div className="mt-10 rounded-xl border border-[var(--surface-soft)] bg-[var(--canvas-raised)] p-6 shadow-[0_18px_50px_rgba(39,37,30,0.08)]">
            ...
            <ol className="mt-5 space-y-5 text-sm">
              <li className="flex gap-3">
                <span className="grid size-10 shrink-0 place-items-center rounded-lg bg-[#e7f7f5] text-[#087f73]">
              ...
              <li className="flex gap-3">
                <span className="grid size-10 shrink-0 place-items-center rounded-lg bg-[#f1ecff] text-[#7656c9]">
                  <Target aria-hidden="true" className="size-5" strokeWidth={1.8} />
                </span>
                <div>
                  <p className="font-medium">Choose your goals</p>
                  <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_62%,transparent)]">Choose what matters first</p>
                </div>
              </li>
            </ol>
          </div>
          ...
          <p className="mt-6 text-xs leading-5 text-[color-mix(in_srgb,var(--ink)_58%,transparent)]">
            No activity is collected during setup.
          </p>
        </div>
      </aside>
    </main>
